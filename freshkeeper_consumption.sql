...
CREATE TABLE `consumption` (
  ...
  `con_quantity` int NOT NULL,
  `amount_spent` decimal(10,2) NOT NULL,
  `health_star_rating` decimal(2,1) NOT NULL,
  ...
  CONSTRAINT `consumption_ibfk_2` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`) ON DELETE CASCADE
